...
<body>
    ...
    <div class="container py-5"> <div class="card p-4 shadow-sm"> <h2 class="profile-header">User Profile</h2>
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                <img src="../uploads/<?php echo htmlspecialchars($user_data['profile_picture'] ?? 'default.jpg'); ?>" alt="Profile Picture" class="profile-picture">
            </div>
            ...
            <div class="profile-info-item">
                ...
                <span class="profile-info-value"><?php echo htmlspecialchars($user_data['full_name'] ?? 'N/A'); ?></span>
            </div>
            <div class="profile-info-item">
            ...
            <div class="profile-info-item">
                ...
                <span class="profile-info-value"><?php echo nl2br(htmlspecialchars($user_data['bio'] ?? 'No bio provided.')); ?></span>
            </div>
